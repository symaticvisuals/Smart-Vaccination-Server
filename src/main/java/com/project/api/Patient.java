...
public class Patient {
    ...
    public Patient(int i, String username, String password, String firstName, String lastName, String aadhaar, String location,
			String bookedDoctor, String date, long phoneNumber) {
		super();
		this.id = i;
