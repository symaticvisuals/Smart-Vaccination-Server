...
public class DoctorRegistrationController {
	...
	public String showRegistrationPage(@ModelAttribute("doctorRegister") DoctorRegistrationDTO doctorRegistrationDTO) {
		doctorRegistrationDTO.setName("abhi");
		doctorRegistrationDTO.setName("abhi123@");
		...
		doctorRegistrationDTO.setCommunicationDTO(communicationDTO);

		return "doctor-registration-page";

	}

	@RequestMapping("/registration-sucess")
	public String processUserRegistration(
			@Valid @ModelAttribute("doctorRegister") DoctorRegistrationDTO doctorRegistrationDTO,
			BindingResult result) {

		System.out.println("inside processUserReg method");
		System.out.println("Name value entered by doctor : " + doctorRegistrationDTO.getName() + "|");

		// validator manually
//		EmailValidator validator = new EmailValidator();
		emailvalidator.validate(doctorRegistrationDTO, result);
